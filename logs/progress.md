...
- Completed Batch 3 for fleets: migrated the Fleets overview plus Lido, El Toro, and Open Fleet pages, and switched the main Fleets navigation item from the legacy site to the local page.
